...
function translatePigLatin(str) {
  let nonVocal = /^[^aeiou]+/g;
  let normaStr = str.toLowerCase();
  let myConsonant = normaStr.match(nonVocal);
  console.log(myConsonant);

  return myConsonant === null
    ? normaStr + "way"
    : normaStr.replace(nonVocal, "") + myConsonant + "ay";
}

console.log(
  //translatePigLatin("Amazon"),
